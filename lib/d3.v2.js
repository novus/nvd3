(function() {
  ...
  function d3_transition(groups, id, time) {
    ...
    groups.d3each = function(type, listener) {
  ...
  d3_selectionPrototype.attr = function(name, value) {
    if (arguments.length < 2) {
      ...
      for (value in name) this.d3each(d3_selection_attr(value, name[value]));
      return this;
    }
    return this.d3each(d3_selection_attr(name, value));
  };
  d3_selectionPrototype.classed = function(name, value) {
    if (arguments.length < 2) {
      ...
      for (value in name) this.d3each(d3_selection_classed(value, name[value]));
      return this;
    }
    return this.d3each(d3_selection_classed(name, value));
  };
  d3_selectionPrototype.style = function(name, value, priority) {
    ...
    if (n < 3) {
      if (typeof name !== "string") {
        if (n < 2) value = "";
        for (priority in name) this.d3each(d3_selection_style(priority, name[priority], value));
        return this;
      }
      if (n < 2) return window.getComputedStyle(this.node(), null).getPropertyValue(name);
      priority = "";
    }
    return this.d3each(d3_selection_style(name, value, priority));
  };
  d3_selectionPrototype.property = function(name, value) {
    if (arguments.length < 2) {
      if (typeof name === "string") return this.node()[name];
      for (value in name) this.d3each(d3_selection_property(value, name[value]));
      return this;
    }
    return this.d3each(d3_selection_property(name, value));
  };
  d3_selectionPrototype.text = function(value) {
    return arguments.length < 1 ? this.node().textContent : this.d3each(typeof value === "function" ? function() {
  ...
  d3_selectionPrototype.html = function(value) {
    return arguments.length < 1 ? this.node().innerHTML : this.d3each(typeof value === "function" ? function() {
      var v = value.apply(this, arguments);
  ...
  d3_selectionPrototype.on = function(type, listener, capture) {
    ...
    if (n < 3) {
      if (typeof type !== "string") {
        ...
        for (capture in type) this.d3each(d3_selection_on(capture, type[capture], listener));
        return this;
      }
      if (n < 2) return (n = this.node()["__on" + type]) && n._;
      capture = false;
    }
    return this.d3each(d3_selection_on(type, listener, capture));
  };
  d3_selectionPrototype.d3each = function(callback) {
  ...
  d3_transitionPrototype.remove = function() {
    return this.d3each("end.transition", function() {
      var p;
