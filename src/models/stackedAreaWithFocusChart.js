...
nv.models.stackedAreaWithFocusChart = function() {
    ...
    stacked2.pointActive(function(d) { return false });
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            focusEnter.select("rect").attr("width",availableWidth).attr("height",availableHeight);

            var contextEnter = gEnter.append('g').attr('class', 'nv-context');
            contextEnter.append("rect").style("opacity",0);
            ...
            var stackedWrap2 = g.select('.nv-context .nv-stackedWrap')
                .datum(data);

            d3.transition(stackedWrap2).call(stacked2);
            ...
            function onBrush() {
                ...
                var focusStackedWrap = g.select('.nv-focus .nv-stackedWrap')
                    .datum(updateData);
                focusStackedWrap.transition().duration(duration).call(stacked);

                // Update Main (Focus) Axes
                g.select('.nv-focus .nv-x.nv-axis').transition().duration(duration)
                    .call(xAxis);
