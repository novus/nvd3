nv.models.parallelCoordinatesChart = function () {
        ...
        , defaultState = null
        , noData = null
        , dispatch = d3.dispatch('dimensionsOrder', 'brushEnd', 'stateChange', 'tooltipShow', 'tooltipHide', 'changeState', 'renderEnd')
        ...
        var showTooltip = function (e, offsetElement) {
            var left = e.pos[0] + (offsetElement.offsetLeft || 0),
                ...
                x = 0,
                y = 0,
                content = e.label !== undefined ? tooltip(e.label, x, y, e, chart) : tooltip(e.dim.tooltip, x, y, e, chart);

            nv.tooltip.show([left, top], content, 'e', null, offsetElement);
        };
        ...
        function chart(selection) {
            ...
            var availableHeight = (height || parseInt(container.style('height')) || 400)
               ...
               if (!defaultState) {
		        ...
		        parallelCoordinates.dispatch.on('elementMouseout.tooltip', function (e) {
        ...
        parallelCoordinates.dispatch.on('elementMouseover.tooltip', function (e) {
