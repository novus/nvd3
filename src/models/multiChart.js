nv.models.multiChart = function() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            var extraValue1BarStacked = bars1.stacked() && dataBars1.length ? dataBars1.filter(function(d){return !d.disabled}).map(function(a){return a.values}).reduce(function(a,b){
                return a.map(function(aVal,i){return {x: aVal.x, y: aVal.y + b[i].y}})
            }).concat([{x:0, y:0}]) : [];
            var extraValue2BarStacked = bars2.stacked() && dataBars2.length ? dataBars2.filter(function(d){return !d.disabled}).map(function(a){return a.values}).reduce(function(a,b){
                return a.map(function(aVal,i){return {x: aVal.x, y: aVal.y + b[i].y}})
            }).concat([{x:0, y:0}]) : [];
