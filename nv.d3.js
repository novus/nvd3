    ...
    selection.each(function(data) {
      ...
      var barsEnter = bars.enter().append('g')
        ...
        .on('click', function(d,i) {
          ...
          d3.event.stopPropagation();
          console.log({ value: getX(d,i), pointIndex: i});
        })
...
nv.models.pixPieChart = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  var margin = {top: 30, right: 20, bottom: 20, left: 20}
    ...
    , color = nv.utils.defaultColor()
    , tooltips = true
    , tooltip = function(key, y, percent, e, graph) {
        return '<h3>' + key + '</h3>' +
               '<p>' +  y + ' ('+ percent +'% )' + '</p>';
      }
    , state = {}
  ...
  var showTooltip = function(e, offsetElement) {
    var tooltipLabel = pie.description()(e.point) || legend.key()(e.point)
    var left = e.pos[0] + ( (offsetElement && offsetElement.offsetLeft) || 0 ),
        top = e.pos[1] + ( (offsetElement && offsetElement.offsetTop) || 0),
        y = pie.valueFormat()(pie.y()(e.point)),
        percent = e.point.x,
        content = tooltip(tooltipLabel, y, percent, e, chart);
